...
class HtmlView(DirectObject):
    ...
    def __init__(self, parent=aspect2d):
        ...
        if GlobalWebcore:
            ...
            GlobalWebcore = AwWebCore(
                AwWebCore.LOGVERBOSE, True, AwWebCore.PFBGRA)
    ...
    def getInGameNewsUrl(self):
        ...
        override = base.config.GetString('in-game-news-url', 'https://cdn.arbitriumstudios.com/bf_assets/tuou/tl_420/tlv_b/tnbot/c1_tpott/pzs_ttfan/game/resources/default/english/phase_3.5/gamenews')
        if override:
            self.notify.info(
    ...
    def _translateRelativeCoordinates(self, x, y):
        ...
        sy = WEB_HEIGHT_PIXELS - \
            int((y - self.mouseLL[1]) / (self.mouseUR[1] -
                self.mouseLL[1]) * WEB_HEIGHT_PIXELS)
        return (sx, sy)
